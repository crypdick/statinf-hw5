...
# how many times true beta_0 was not captured by the confint for our fitted model
      sim_results$bad_intercept_rate <- sim_results$bad_intercept_rate + 1
...
# frequency % p-val(intercept) was >0.05      
      sim_results$insignificant_intercept_rate <- sim_results$insignificant_intercept_rate + 1
    if (sum(p_vals[-1] > .05) >= 1) 
# freq that params for predictors had p-val > 0.05 in all our sims. on interval (0,1)
