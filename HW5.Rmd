...
my.simulation <- function(n, b0, b1){
  choices.simulation <- c("normal", "nonnormal")
  random.choice <- sample(choices.simulation, 1)
  if (random.choice == "normal"){
    return(normal_func)
  }
  else{
    return(nonnormal_func)
  }
}
```
